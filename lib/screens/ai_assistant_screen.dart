...
当前周次：第${StorageService.getCurrentWeek()}周${StorageService.getCurrentWeek() > StorageService.getSemesterWeeks() ? '\n当前状态：假期（已超出学期${StorageService.getSemesterWeeks()}周），用户处于假期中，回答时侧重假期学习建议、任务提醒与作息调整，不必再讨论今日课程安排。' : ''}
