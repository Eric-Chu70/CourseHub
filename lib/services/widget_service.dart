...
class WidgetService {
  ...
  static Map<String, dynamic> _buildTodayData() {
    ...
    final isHoliday = currentWeek > semesterWeeks || StorageService.isBeforeSemesterStart();
    ...
    // 假期时清空课程列表，小组件不显示任何课程
    final coursesJson = isHoliday
        ? <Map<String, dynamic>>[]
        : todayCourses.map((c) => _courseToJson(c, timeSlots, includeDay: false)).toList();
